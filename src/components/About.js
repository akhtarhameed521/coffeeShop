...
export default function AboutSection() {
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start  gap-20 mt-[100px] p-10 ">
        <div className="mb-10 order-2 lg:order-1 ">
          <div className="flex flex-col lg:flex-row items-end gap-5 mb-5 ">
            <div className=" relative  w-full  h-[356px] lg:w-[362px] ">
              <Image src="/food5.png" layout="fill" objectFit="cover" />
            </div>
            <div className=" relative w-full h-[231px] lg:w-[281px] ">
              <Image src="/food6.png" layout="fill" objectFit="cover" />
            </div>
          </div>
          <div className="flex flex-col lg:flex-row gap-5">
            <div className="flex flex-col lg:flex-row gap-5">
              <div className=" relative w-[244px] h-[306px] ">
                <Image src={"/food7.png"} layout="fill" objectFit="cover" />
              </div>
              <div className=" relative w-[221px] h-[226px] ">
                <Image src={"/food8.png"} layout="fill" objectFit="cover" />
              </div>
            </div>
            <div>
              <div className=" relative w-[161px] h-[168px] mb-3 ">
                <Image src={"/food9.png"} layout="fill" objectFit="cover" />
              </div>
              <div className=" relative w-[161px] h-[168px] ">
                <Image src={"/food10.png"} layout="fill" objectFit="cover" />
              </div>
            </div>
          </div>
        </div>
        <div className=" mt-14 order-1 lg:order-2 text-center lg:text-start ">
          <h4 className=" font-cursive text-primary text-3xl mb-5">
            why choose us
          </h4>
          ...
          <div className="flex justify-center lg:justify-start gap-10 mt-[30px] text-center ">
            <div>
              <div className=" relative w-[31px] h-[38px] rounded-md bg-[#FF9F0D] p-10 ">
                <Image src={"/Hamburger.png"} layout="fill" objectFit="cover" />
              </div>
              <h5 className=" mt-2 "> fast food </h5>
            </div>
            <div>
              <div className=" relative w-[31px] h-[38px] rounded-md bg-[#FF9F0D] p-10 ">
                <Image src={"/Cookie.png"} layout="fill" objectFit="cover" />
              </div>
              <h5 className=" mt-2 "> lunch </h5>
            </div>
            <div>
              <div className=" relative w-[31px] h-[38px] rounded-md bg-[#FF9F0D] p-10 ">
                <Image src={"/Wine.png"} layout="fill" objectFit="cover" />
              </div>
          ...
          <div className="mt-20">
            <div className="flex gap-10 border-[#FF9F0D] border-l-[20px] rounded-lg p-3 bg-white text-black ">
              <div className="ml-16 flex gap-14 items-center">
                <h3 className=" font-bold text-3xl text-[#FF9F0D] ">30+</h3>
                <div>
                  <p className="text-sm">years of</p>
                  <p className="text-md font-bold">Experienced</p>
                </div>
              </div>
            </div>
          </div>
